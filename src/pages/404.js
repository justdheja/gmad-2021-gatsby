    ...
    <Layout>
      <div className="bg-header-home w-full">
        <main className="max-w-4xl min-h-screen flex-grow mx-auto flex flex-col justify-around items-center p-8">
          ...
          <Link to="/" className="p-2 md:ml-0 font-semibold cursor-pointer bg-palette-orange hover:bg-palette-dusty text-sm text-white transition ease-in duration-200 text-center text-base w-6/12 shadow-lg rounded-full">
            Back to Home
          </Link>
        </main>
      </div>
